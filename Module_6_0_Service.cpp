...
Module_6_0_Service::Module_6_0_Service(BLEAdvManager &_BLEAdvManager, uint8_t moduleNo) : m_bleAdvManager(_BLEAdvManager), m_moduleNo(moduleNo) {
...
void Module_6_0_Service::sendData() {
...
void Module_6_0_Service::setChannel(uint8_t channel, float value) {
...
void Module_6_0_Service::setChannelOffset(uint8_t channel, float offset) {
